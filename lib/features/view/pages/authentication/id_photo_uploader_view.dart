...
class IdPhotoUploaderScreen extends StatefulWidget {
  IdPhotoUploaderScreen({super.key});

  @override
  State<IdPhotoUploaderScreen> createState() => _IdPhotoUploaderScreenState();
}

class _IdPhotoUploaderScreenState extends State<IdPhotoUploaderScreen> {
                ...
                GestureDetector(
                  ...
                  child: Container(
                    margin: EdgeInsets.only(
                        top: 50, bottom: 15, left: 12, right: 15),
                    height: 200,
